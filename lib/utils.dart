...
class Theming {
  ...
  static Gradient coloredGradient = const LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
      colors: <Color>[Color.fromARGB(255, 135, 0, 193), Color.fromARGB(255, 34, 0, 253)]);

  static Gradient grayGradient = const LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
  ...
  static Container grayOutline(Widget child, {double outerPadding = 0.0}) {
    return Container(
        ...
        child: Container(
            ...
            child: Container(decoration: innerDeco, padding: EdgeInsets.all(outerPadding), child: child)));
  }
