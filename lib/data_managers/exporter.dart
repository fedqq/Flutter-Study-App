...
pw.Page subjectToPdf(Subject subject, int scoresToShow) {
  return pw.Page(
...
void printSubject(Subject subject, int scoresToShow) async {
...
List<pw.Widget> getScoresList(pw.Context context, Subject subject, int scoresToShow) => [
...
pw.Widget topicWidget(pw.Context context, Topic topic) {
  return pw.Align(
